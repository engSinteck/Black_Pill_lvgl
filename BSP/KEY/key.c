...
uint8_t PushButton_Read(uint8_t key)
{
	...
	switch(key) {
		case 0:			// Down
			ret = !(HAL_GPIO_ReadPin(ENC1_SW_GPIO_Port, ENC1_SW_Pin));
			break;
		case 1:			// UP
			ret = !(HAL_GPIO_ReadPin(ENC2_SW_GPIO_Port, ENC2_SW_Pin));
			break;
		case 2:			// Enter
			ret = !(HAL_GPIO_ReadPin(ENC3_SW_GPIO_Port, ENC3_SW_Pin));
			break;
		default:
			break;
	}
